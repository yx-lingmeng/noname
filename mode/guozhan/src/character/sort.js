...
export default {
	...
	guozhan_wushuang: ["gz_zhangyao", "gz_caochun", "gz_mizhu", "gz_shichangshi", "gz_yj_zhanghe", "gz_gaolan", "gz_caoang", "gz_zhangxingcai", "gz_luzhi", "gz_quyi", "gz_ws_caoying", "gz_ws_guansuo", "gz_zhangxuan", "gz_guanyinping", "gz_xinxianying"],
	...
	guozhan_online: ["gz_re_lvbu", "gz_ol_yuanshao", "gz_re_menghuo", "gz_ol_sp_zhugeliang", "gz_re_ganning", "gz_re_zhangliao", "gz_luzhi", "gz_ol_wangrong", "gz_sp_ol_zhanghe", "gz_zhugezhan", "gz_sunhao", "gz_yanrou", "gz_ol_xuyou", "gz_ol_wuyi", "gz_ol_zhonghui", "gz_chengpu", "gz_liaohua", "gz_caochong", "gz_liuyan", "gz_re_xusheng", "gz_ol_sb_sunjian", "gz_re_huanggai", "gz_re_xuzhu", "gz_ol_weiyan", "gz_ol_yanwen", "gz_zhangsong", "gz_re_huangyueying", "gz_re_caocao", "gz_re_zhangjiao", "gz_re_luxun"],
