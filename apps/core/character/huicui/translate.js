const translates = {
	...
	qingtan: "清谈",
	qingtan_info: "出牌阶段限两次，你可令所有有手牌的角色同时选择一张手牌并同时展示。你可以获得其中一种花色的牌，然后展示此花色牌的角色各摸一张牌。若如此做，弃置其他的牌。",
	qingtan_append: `<span style="font-family: yuanli"><li>该技能为海外版本</span>`,
	zhaoyan: "赵嫣",
	jinhui: "锦绘",
	...
	dcchongxu: "冲虚",
	dcchongxu_info: "限定技。出牌阶段，若“灵”数不小于4，你可以失去〖汇灵〗，增加等同于“灵”数的体力上限（至多增加游戏人数的体力上限），然后获得〖踏寂〗和〖清荒〗。",
	dctaji: "踏寂",
