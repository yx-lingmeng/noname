...
const translates = {
	dc_xia_wangyue: "王越",
	wudou: "武斗",
	wudou_info: "每回合每项限一次：1.其他角色对你使用伤害牌结算后，你可以视为对其使用一张【决斗】；2.其他角色使用【决斗】指定目标后，若目标不为你，你可将目标更改为你。",
	jiandao: "剑道",
	jiandao_info: "锁定技。①你的伤害锦囊牌视为【决斗】。②你参与的【决斗】结算后你摸一张【杀】且此【杀】无次数限制。③你造成渠道为【决斗】的伤害后你下次使用【杀】不可响应。④你每造成两次渠道为【杀】的伤害，本局游戏你的【杀】伤害+1。",
	shie: "史阿",
	liren: "砺刃",
	liren_info: "锁定技。①你的攻击范围始终为2。②当【杀】造成伤害后，你获得此【杀】。③当【杀】被抵消后，你摸一张牌。",
	sejianchu: "剑出",
	...
	dcsbshedao: "慑道",
	dcsbshedao_info: "你的回合内，其他角色的红色牌进入弃牌堆后，你可以获得这些牌并选择一项：1.弃置等量的黑色牌，然后本回合你以此法获得的红色牌不计入手牌上限；2.将其中的【杀】均替换为雷【杀】，然后此技能本回合失效。",
	dcsbxunshi: "迅矢",
	dcsbxunshi_info: "你使用的雷【杀】无距离和次数限制，且造成伤害后可以摸一张牌。",
	dcsbzhengong: "震弓",
	dcsbzhengong_info: "限定技，出牌阶段，你可以弃置至少两张同名牌，然后对任意名其他角色造成共计与弃牌数等量的伤害，因此受到伤害的角色本回合非锁定技失效。",
	v_zhangxingcai: "威张星彩",
	v_zhangxingcai_prefix: "威",
	dchuangnu: "煌怒",
	dchuangnu_info: "出牌阶段或受到伤害后，你可选择一项执行：1.弃置一名角色X张手牌；2.你视为使用一张无距离限制的【杀】；3.令一名角色本回合下次使用牌无效。执行后随机恢复X个装备栏，若恢复数不足对应数量则此技能失效至本回合结束。（X为此技能本回合发动的次数）",
	dcxiankuang: "贤贶",
	dcxiankuang_info: "每回合每名角色限一次，有角色因弃置失去基本牌后，你可废除一个装备栏，令此角色摸你废除的装备栏数张牌。",
	liuxuan: "刘璿",
	mogui: "漠规",
	mogui_info: "你的回合开始时，选择2项执行：1.弃置一名角色判定区的所有牌，然后你的下个判定阶段进行一次【乐不思蜀】判定；2.跳过你的摸牌阶段，令一名角色下个摸牌阶段摸牌数+1，下个出牌阶段使用【杀】次数+1；3.弃牌阶段你须弃置所有手牌，令一名角色回复1点体力且下回合手牌上限+1。",
	zunjian: "遵谏",
	zunjian_info: `限定技，你进入濒死状态时，可失去${get.poptip("mogui")}并回复X点体力并摸等量张牌，然后获得${get.poptip("rencheng")}。（X为${get.poptip("mogui")}执行过的选项数且至少为1）`,
	rencheng: "仁诚",
	rencheng_info: "出牌阶段限一次，你可以摸三张牌然后可交给一名其他角色至多三张牌，若其因此获得牌的类型数：为1，其下个出牌阶段使用【杀】的次数+1；为2，其下个摸牌阶段摸牌数+2；为3，你与其各回复1点体力并摸一张牌。",
	zhangyu: "张裕",
	dcxiangchen: "相谶",
	dcxiangchen_info: "出牌阶段限一次，你可选择一名角色并随机出现与其势力和初始体力值相等的武将的3个技能，然后你从中选择1个获得，你的回合结束时失去以此法获得的技能并回复1点体力。你或上次发动〖相谶〗的目标角色体力值变化后，你可发动此技能。（以此法获得的技能存在3个时再次发动改为摸一张牌，无法获得限定技、觉醒技、主公技)",
	dcmingding: "命定",
	dcmingding_info: `限定技，你进入濒死状态时，可失去除〖命定〗外的所有技能并将体力值回复至1点，然后直到你的下个回合结束，防止你受到的伤害。如若此做，你摸发动${get.poptip("dcxiangchen")}获得过的技能数张牌（至多5张）并随机获得其中4个技能，然后你的下个回合结束时你失去所有体力。`,
	shen_jiangwei: "神姜维",
	...
	pingxiang: "平襄",
	pingxiang_info: `限定技。出牌阶段，若你的体力上限大于⑨，则你可减⑨点体力上限，视为使用至多⑨张火【杀】，然后失去${get.poptip("jiufa")}，并将手牌上限基数改为体力上限直到游戏结束。`,
	shen_machao: "神马超",
	...
	dukui: "杜夔",
	dcfanyin: "泛音",
	dcfanyin_info: "出牌阶段开始时，你可以亮出牌堆中点数最小的一张牌A。然后你选择一项，并可以亮出一张点数为X的牌B（X为牌A点数的二倍，若牌B不存在，则牌B改为点数最不小于X的牌）且重复此流程：⒈使用此牌B（无距离限制）；⒉你于本回合内使用的下一张基本牌或普通锦囊牌选择目标后，可以增加一个目标。",
	dcpeiqi: "配器",
	...
	dcsbronghuo: "融火",
	dcsbronghuo_info: "锁定技，有角色受到火焰伤害后，你下一次使用火【杀】或【火攻】额外指定1个目标（不可叠加），你使用火【杀】或【火攻】造成的伤害+X (X为全场势力数)。",
	dcsbyingmou: "英谋",
	dcsbyingmou_info: "转换技。①游戏开始时，你可以转换此技能状态；②每回合限一次，当你对其他角色使用牌后，你可以选择其中一名目标角色：阳，你将手牌数摸至与其相同（至多摸五张），然后视为对其使用一张【火攻】；阴，令一名手牌数为全场最大的角色对其使用手牌中所有的【杀】和伤害类锦囊牌（若其没有可使用的牌则将手牌数弃至与你相同）。若其未因此受到伤害，你对其造成1点火焰伤害。",
	caoxian: "曹宪",
	dclingxi: "灵犀",
	...
	dcwuxie: "无胁",
	dcwuxie_info: "回合结束时，你可以选择一名其他角色，与其交换手牌，然后你将手牌中全部伤害牌置于牌堆底。",
	liutan: "柳婒",
	dcjingyin: "经音",
	...
	dcyuanrong: "圆融",
	dcyuanrong_info: "回合结束时，你可以将本回合进入弃牌堆的一张黑色牌当任意普通锦囊牌使用，然后你可以将本回合进入弃牌堆的一张红色牌当任意基本牌使用。",
	dc_zhushuo: "朱铄",
	dczsshuhe: "疏和",
	...
	guotiying: "郭缇萦",
	dckanyu: "堪舆",
	dckanyu_info: "一名角色进行判定或当你受到伤害时，你可观看牌堆顶与牌堆底各一张牌，然后可获得其中任意张牌，并将剩余牌以任意顺序放回。若你以此法获得牌，【闪电】对你的生效范围增加你所获得牌的花色点数组合。",
	dczhee: "谪厄",
	...
	dcsbmoyou: "谟猷",
	dcsbmoyou_info: "你每使用两张手牌结算后，可以摸三张牌，并选择一种花色弃置手牌中所有此花色的牌，若你手牌未含有所有类型，则本回合手牌上限+1且下次使用基本牌无次数与距离限制，使用锦囊牌不可响应。",
	dcsbshiao: "恃傲",
	...
	dcsbhongce: "宏策",
	dcsbhongce_info: "①首轮开始时，你令一名角色选择一项执行：1.将半数手牌（向上取整）替换为伤害牌，视为使用一张【杀】；2.重铸一张手牌，视为使用一张单目标普通锦囊牌；3.摸三张牌且这些牌不计入手牌上限。②出牌阶段限一次，你可令一名角色执行你〖宏策①〗选择的项。",
	dc_sb_wuyi: "新杀谋吴懿",
	dc_sb_wuyi_prefix: "新杀谋",
	dcsbshibian: "识变",
	dcsbshibian_info: "每轮开始时，你可选择一名其他角色，本轮其攻击范围内的角色视为在你攻击范围内，且你使用【杀】或普通锦囊牌可指定一名其攻击范围内的角色为额外目标。",
	dcsbbibu: "庇部",
	dcsbbibu_info: "你的上家或下家每回合首次成为其他角色的【杀】或普通锦囊牌的唯一目标时，你可摸一张牌并令此牌的目标改为你；你的上家或下家每回合首次使用【杀】或普通锦囊牌结算结束后，你可摸一张牌，视为使用此牌。",
	dc_sb_fazheng: "新杀谋法正",
	...
	v_liubei_prefix: "威",
	dcliexiang: "烈骧",
	dcliexiang_info: "出牌阶段限一次，你可摸至多五张牌并对一名其他角色造成1点伤害，若你的手牌数：1.大于其，本回合你出【杀】次数+1且可以交给一名其他角色至多X张牌；2.等于其，你获得其一张牌且其下回合使用的前X张牌无效；3.小于其，你失去X点体力并对其造成1点伤害，此技能本回合修改为“出牌阶段限两次”且可额外选择至多X名其他角色（X为你选择的摸牌数）。",
	dcrengou: "仁彀",
	dcrengou_info: `其他蜀势力角色的出牌阶段限一次，其可弃置一张牌并令你回复1点体力，然后你可令其发动一次至多摸两张牌的${get.poptip("dcliexiang")}。`,
	v_gongsunzan: "威公孙瓒",
	v_gongsunzan_prefix: "威",
	dcjuxi: "举袭",
	dcjuxi_info: "出牌阶段限一次，若你手牌中无可使用的伤害牌， 你可视为使用一张本回合未以此法使用过的伤害牌，若本阶段此牌名进入弃牌堆，此技能视为未发动。",
	dczhuitao: "追讨",
	...
	dcczchouxi: "仇隙",
	dcczchouxi_info: "限定技，出牌阶段或受到伤害后，你可视为对一名其他角色使用一张无距离限制的【杀】，若该角色本轮对你造成过伤害，其随机弃置一张手牌。当你弃置手牌时，若弃置手牌数不小于当前你剩余手牌数，此技能视为未发动过。",
};
