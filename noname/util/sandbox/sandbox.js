...
const SandboxExposer = /* @__PURE__ */ Symbol("Sandbox.Exposer");
const SandboxExposer2 = /* @__PURE__ */ Symbol("Sandbox.Exposer2");
const SandboxSignal_InitDomain = /* @__PURE__ */ Symbol("InitDomain");
const SandboxSignal_GetMarshalledProxy = /* @__PURE__ */ Symbol("GetMarshalledProxy");
const SandboxSignal_SetMarshalledProxy = /* @__PURE__ */ Symbol("SetMarshalledProxy");
const SandboxSignal_GetWindow = /* @__PURE__ */ Symbol("GetWindow");
const SandboxSignal_GetPromise = /* @__PURE__ */ Symbol("GetPromise");
const SandboxSignal_EnterDomain = /* @__PURE__ */ Symbol("EnterDomain");
const SandboxSignal_ExitDomain = /* @__PURE__ */ Symbol("ExitDomain");
const SandboxSignal_ListDomain = /* @__PURE__ */ Symbol("ListDomain");
const SandboxSignal_UnpackProxy = /* @__PURE__ */ Symbol("UnpackProxy");
const SandboxSignal_Marshal = /* @__PURE__ */ Symbol("Marshal");
const SandboxSignal_MarshalArray = /* @__PURE__ */ Symbol("MarshalArray");
const SandboxSignal_TrapDomain = /* @__PURE__ */ Symbol("TrapDomain");
const SandboxSignal_DiapatchMonitor = /* @__PURE__ */ Symbol("DiapatchMonitor");
const SandboxSignal_ListMonitor = /* @__PURE__ */ Symbol("ListMonitor");
const SandboxSignal_ExposeInfo = /* @__PURE__ */ Symbol("ExposeInfo");
const SandboxSignal_TryFunctionRefs = /* @__PURE__ */ Symbol("TryFunctionRefs");
let CodeSnippet;
let ErrorReporter;
let ErrorManager;
const WeakRef = window.WeakRef || class WeakRef2 {
  /**
   * @param {any} target
   */
  constructor(target) {
...
class Rule {
  ...
  allowMarshalTo(domain) {
    ...
    if (!this.#allowMarshalTo) {
      ...
      this.#allowMarshalTo = /* @__PURE__ */ new WeakSet();
    }
  ...
  disallowMarshalTo(domain) {
    ...
    if (!this.#disallowMarshalTo) {
      ...
      this.#disallowMarshalTo = /* @__PURE__ */ new WeakSet();
    }
...
function buildGlobalIndexes(window2, selector) {
  ...
  while (pathes.length) {
    ...
    if (path.length == 2) {
      ...
      const root2 = path[0];
      const pattern2 = path[1];
      indexes.push(
        ...Reflect.ownKeys(root2).filter((k) => k in root2 && pattern2.test(typeof k == "string" ? k : `@${k.description}`)).map((k) => [root2, k])
      );
      continue;
    }
    if (!(path[1] instanceof RegExp)) {
      const root2 = path.shift();
      if (path[0] === "__proto__") {
        path[0] = Reflect.getPrototypeOf(root2);
      } else {
        path[0] = root2[path[0]];
      }
      if (!path[0]) {
    ...
    const keys = Reflect.ownKeys(root).filter((k) => k in root && pattern.test(typeof k == "string" ? k : `@${k.description}`));
    if (!keys.length) {
      continue;
    }
...
const MARSHALLED_LIST = Object.freeze([
  ...
  ...Reflect.ownKeys(globalThis).filter((key) => typeof key == "string").filter((key) => /^\w*?Event$/.test(key)).map((key) => `/${key}`)
]);
class Globals {
  /** @type {[WeakMap, Object, Object]} */
  static #topGlobals;
  /** @type {WeakMap<Domain, [WeakMap, Object]>} */
  static #globals = /* @__PURE__ */ new WeakMap();
  ...
  static isBuiltinKey(key) {
    return key in Globals.#builtinKeys;
  }
  /**
   * ```plain
   * 解析映射路径
  ...
  static parseFrom(path, window2) {
    if (typeof path == "string") {
      ...
      return [path[0], window2.eval(path[1])];
    }
  }
  /**
   * ```plain
   ...
   */
  static parseIndex(path, window2) {
    const items = path.split("/").filter(Boolean);
  ...
  static ensureDomainGlobals(domain) {
    if (!Globals.#globals.has(domain)) {
      const window2 = domain[SandboxExposer](SandboxSignal_GetWindow);
      const globals = [/* @__PURE__ */ new WeakMap(), {}];
      ...
      if (Globals.#topGlobals) {
        ...
        for (const path of MARSHALLED_LIST) {
          const [obj, key] = Globals.parseIndex(path, window2);
        ...
        globals.push({});
        for (const path of MARSHALLED_LIST) {
          const [key, obj] = Globals.parseFrom(path, window2);
          if (obj == null) {
            continue;
          }
          globals[2][key] = obj;
        }
        for (const key of Reflect.ownKeys(window2)) {
...
class NativeWrapper {
  static #unboxedFunction = /* @__PURE__ */ Symbol("NativeWrapper.unboxedFunction");
  /** @type {WeakMap<Proxy, Function>} */
  static #boxedMap = /* @__PURE__ */ new WeakMap();
  /** @type {WeakSet<Function>} */
  static #boxedSet = /* @__PURE__ */ new WeakSet();
  ...
  static wrapApply(func, flags = 0) {
    ...
    const wrapped = flags & 2 ? function(...args) {
...
class DomainMonitors {
  ...
  static #domainMonitors = /* @__PURE__ */ new WeakMap();
  /** @type {WeakMap<Object, Record<number, Set<Monitor>>>} */
  #targetMonitorsMap = /* @__PURE__ */ new WeakMap();
  /** @type {WeakMap<Domain, Record<number, Set<Monitor>>>} */
  #monitorsMap = /* @__PURE__ */ new WeakMap();
  /**
   * ```plain
   * 在当前运行域安装一个 Monitor
   * ```
  ...
  static #installMonitor(thiz, monitor) {
    ...
    function addToActionMap(actionMap) {
      for (const action of actions) {
        ...
        if (!monitorMap) {
          monitorMap = actionMap[action] = /* @__PURE__ */ new Set();
        }
  ...
  static #handleNewDomain(thiz, domain) {
    ...
    for (const monitor of Monitor[SandboxExposer2](SandboxSignal_ListMonitor)) {
      ...
      for (const action of actions) {
        ...
        if (!monitors) {
          monitors = actionMap[action] = /* @__PURE__ */ new Set();
        }
...
class Monitor {
  /** @type {Set<Monitor>} */
  static #monitorSet = /* @__PURE__ */ new Set();
  /** @type {Domain} */
  #domain;
  /** @type {Set<Domain>?} */
  #allowDomains = null;
  ...
  require(name, ...values) {
    ...
    if (!info) {
      info = this.#checkInfo[name] = /* @__PURE__ */ new Set();
    }
...
class Marshal {
  static #revertTarget = /* @__PURE__ */ Symbol("Marshal.revertTarget");
  static #sourceDomain = /* @__PURE__ */ Symbol("Marshal.sourceDomain");
  static #marshalRules = /* @__PURE__ */ new WeakMap();
  static #marshalledProxies = /* @__PURE__ */ new WeakSet();
  constructor() {
  ...
  static canCreateFunction(paramList, funcBody, type = null) {
    ...
    if (type == "any") {
      return ["async", "generator", "agenerator", null].some((t) => Marshal.canCreateFunction(t, paramList, funcBody));
    }
    try {
      switch (type) {
        default:
  ...
  static #marshalArray(array, targetDomain) {
    ...
    const window2 = targetDomain[SandboxExposer](SandboxSignal_GetWindow);
    const newArray = new window2.Array(array.length);
  ...
  static #marshalObject(object, targetDomain) {
    ...
    const window2 = targetDomain[SandboxExposer](SandboxSignal_GetWindow);
    const newObject = new window2.Object();
  ...
  static #marshal(obj, targetDomain) {
    ...
    if (sourceDomain.isError(target)) {
      ...
      if (mappedCtor) {
        ...
        ErrorManager.setErrorReporter(newError, errorReporter || new ErrorReporter(target));
        return newError;
      }
    }
    ...
    const proxy = new Proxy(pure, {
      ...
      apply(_, thisArg, argArray) {
        const defaultApply = () => {
          ...
          return Marshal.#trapDomain(sourceDomain, () => {
            const rule2 = ruleRef.rule;
            if (rule2 && !rule2.canAccess(AccessAction.CALL, target, marshalledThis, marshalledArgs)) {
      ...
      construct(_, argArray, newTarget) {
        ...
        return Marshal.#trapDomain(sourceDomain, () => {
          const rule2 = ruleRef.rule;
          if (rule2 && !rule2.canAccess(AccessAction.NEW, target, argArray, newTarget)) {
            throw new ReferenceError("封送对象的源运行域禁止了此项操作");
          }
      ...
      defineProperty(_, property, attributes) {
        ...
        if (!isSourceDomain) {
          ...
          const window2 = sourceDomain[SandboxExposer](SandboxSignal_GetWindow);
          const descriptor = new window2.Object();
        ...
        const domainTrapAction = () => {
          const rule2 = ruleRef.rule;
          if (rule2 && !rule2.canAccess(AccessAction.DEFINE, target, property, attributes)) {
            throw new ReferenceError("封送对象的源运行域禁止了此项操作");
          }
      ...
      deleteProperty(_, p) {
        return Marshal.#trapDomain(sourceDomain, () => {
          const rule2 = ruleRef.rule;
          if (rule2 && !rule2.canAccess(AccessAction.DELETE, target, p)) {
            throw new ReferenceError("封送对象的源运行域禁止了此项操作");
          }
          const args = [target, p];
      ...
      get(_, p, receiver) {
        ...
        return Marshal.#trapDomain(sourceDomain, () => {
          const rule2 = ruleRef.rule;
          if (rule2 && !rule2.canAccess(AccessAction.READ, target, p, marshalledReceiver)) {
            throw new ReferenceError("封送对象的源运行域禁止了此项操作");
          }
      ...
      getOwnPropertyDescriptor(_, p) {
        ...
        const domainTrapAction = () => {
          const rule2 = ruleRef.rule;
          if (rule2 && !rule2.canAccess(AccessAction.DESCRIBE, target, p)) {
            throw new ReferenceError("封送对象的源运行域禁止了此项操作");
          }
          const args = [target, p];
      ...
      getPrototypeOf(_) {
        return Marshal.#trapDomain(sourceDomain, () => {
          const rule2 = ruleRef.rule;
          if (rule2 && !rule2.canAccess(AccessAction.TRACE, target)) {
            throw new ReferenceError("封送对象的源运行域禁止了此项操作");
          }
          const args = [target];
      ...
      has(_, p) {
        ...
        const domainTrapAction = () => {
          const rule2 = ruleRef.rule;
          if (rule2 && !rule2.canAccess(AccessAction.EXISTS, target, p)) {
            throw new ReferenceError("封送对象的源运行域禁止了此项操作");
          }
          const args = [target, p];
      ...
      ownKeys(_) {
        return Marshal.#trapDomain(sourceDomain, () => {
          const rule2 = ruleRef.rule;
          if (rule2 && !rule2.canAccess(AccessAction.LIST, target)) {
            throw new ReferenceError("封送对象的源运行域禁止了此项操作");
          }
          const args = [target];
      ...
      preventExtensions(_) {
        return Marshal.#trapDomain(sourceDomain, () => {
          const rule2 = ruleRef.rule;
          if (rule2 && !rule2.canAccess(AccessAction.SEAL, target)) {
            throw new ReferenceError("封送对象的源运行域禁止了此项操作");
          }
          const args = [target];
      ...
      set(_, p, newValue, receiver) {
        ...
        return Marshal.#trapDomain(sourceDomain, () => {
          const rule2 = ruleRef.rule;
          if (rule2 && !rule2.canAccess(AccessAction.WRITE, target, p, marshalledNewValue, marshalledReceiver)) {
            throw new ReferenceError("封送对象的源运行域禁止了此项操作");
          }
      ...
      setPrototypeOf(_, v) {
        ...
        return Marshal.#trapDomain(sourceDomain, () => {
          const rule2 = ruleRef.rule;
          if (rule2 && !rule2.canAccess(AccessAction.META, target, marshalledV)) {
            throw new ReferenceError("封送对象的源运行域禁止了此项操作");
          }
...
class Domain {
  ...
  #marshalledCached = /* @__PURE__ */ new WeakMap();
  /**
   * ```plain
   * 创建运行域
   *
...
class Sandbox {
  ...
  static #domainMap = /* @__PURE__ */ new WeakMap();
  /** @type {Array} */
  static #executingScope = [];
  /** @type {WeakMap<Function, string>} */
  static #functionRefCodes = /* @__PURE__ */ new WeakMap();
  /** @type {string?} */
  #persistId;
  /** @type {Storage?} */
  #proxyStorage;
...
${code}
  ...
  initBuiltins() {
    ...
    builtins.exports = void 0;
    builtins.define = void 0;
...
// 沙盒代码结束
    ...
    const snippet = new CodeSnippet(code, 5);
...
if (SANDBOX_ENABLED) {
  if (window.top === window) {
    ...
    sealClass((async function() {
    }).constructor);
    sealClass((async function* () {
    }).constructor);
    Domain[SandboxExposer2](SandboxSignal_InitDomain);
    ({ CodeSnippet, ErrorReporter, ErrorManager } = // @ts-expect-error Sandbox
