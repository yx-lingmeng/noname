import "../../noname.js";
import { GeneratorFunction, AsyncFunction, userAgentLowerCase } from "../util/index.js";
...
class Is {
      ...
      for (let i = 0; i < substring.length; i++) {
        ...
        if (55296 <= hs && hs <= 56319) {
          if (substring.length > 1) {
            ...
            const uc = (hs - 55296) * 1024 + (ls - 56320) + 65536;
          ...
          if (8448 <= hs && hs <= 10239) {
            return true;
          } else if (11013 <= hs && hs <= 11015) {
            return true;
          } else if (10548 <= hs && hs <= 10549) {
            return true;
          } else if (12951 <= hs && hs <= 12953) {
            return true;
          } else if (hs == 169 || hs == 174 || hs == 12349 || hs == 12336 || hs == 11093 || hs == 11036 || hs == 11035 || hs == 11088) {
            return true;
          }
        }
      }
  ...
  zhuanhuanji(skill, player) {
    const info = get.info(skill), { zhuanhuanji } = info;
