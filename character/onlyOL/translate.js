...
const translates = {
	...
	olsbdanchi: "胆持",
	olsbdanchi_info: "每回合限一次，你造成或受到伤害后，你可令受到伤害的角色选择一个类型。然后伤害来源本回合使用下一张牌后，你视为使用一张【无中生有】，若与”胆持”选择的类型不同，你额外可视为使用一张【杀】。",
	old_olsbdanchi: "胆持",
	...
	olsblucun: "赂存",
	olsblucun_info: "每轮各限一次，你可以视为使用一张未以此法使用过的基本牌或普通锦囊牌，然后目标中手牌最多的随机一名角色将一张手牌置于你的武将牌上，称为“赂”。每个回合结束时，随机移去一张“赂”，你摸一张牌。",
	olsbtuisheng: "蜕生",
	olsbtuisheng_info: "限定技，准备阶段或当你进入濒死状态时，你可以重置本局〖赂存〗使用过的牌名，然后你选择一项并回复1点体力：①将所有手牌置于你的武将牌上，称为“赂”；②你随机从弃牌堆中获得游戏轮数张重置前“赂存”使用牌名的牌。",
	ol_sb_wenchou: "OL谋文丑",
