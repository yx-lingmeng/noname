...
const translates = {
	...
	dcsbmoyou: "谟猷",
	dcsbmoyou_info: "你每使用两张手牌结算后，可以摸四张牌，并选择一种花色弃置手牌中所有此花色的牌，若你手牌未含有所有类型，本回合下次使用基本牌无次数与距离限制，使用锦囊牌不可响应。",
	dcsbshiao: "恃傲",
	...
	v_liubei_prefix: "威",
	dcliexiang: "烈骧",
	dcliexiang_info: "出牌阶段限一次，你可摸至多X张牌（X为游戏人数且至多为5），然后选择一名其他角色，若你的手牌数：1.大于其，其本回合视为在你攻击范围内且不能响应你的牌；2.等于其，你获得其一张牌且本回合下次对其造成的伤害+1；3.小于其，你失去2点体力并对其造成1点伤害，此技能本回合修改为“出牌阶段限两次”且可选择至多三名其他角色。",
	dcrengou: "仁彀",
	dcrengou_info: `其他蜀势力角色的出牌阶段限一次，其可弃置一张牌并令你回复1点体力，然后你可令其发动一次X为2的${get.poptip("dcliexiang")}。`,
	v_gongsunzan: "威公孙瓒",
