...
const translates = {
	dc_xia_wangyue: "王越",
	wudou: "武斗",
	wudou_info: "每回合每项限一次，1.其他角色对你使用伤害牌结算后，你可视为对其使用一张【决斗】；2.其他角色使用【决斗】指定目标后，若目标不为你，你可将目标更改为你。",
	jiandao: "剑道",
	jiandao_info: "锁定技。你的伤害锦囊牌视为【决斗】。你参与的【决斗】结算后你摸一张【杀】且此【杀】无次数限制。你造成渠道为【决斗】的伤害后你下次使用【杀】不可响应。你每造成2次渠道为【杀】的伤害，本局游戏你的【杀】伤害+1。",
	shie: "史阿",
	liren: "砺刃",
	liren_info: "锁定技，你的攻击范围始终为2。有【杀】造成伤害后，你获得此【杀】；有【杀】被抵消后，你摸一张牌。",
	sejianchu: "剑出",
	...
	v_sunce_prefix: "威",
	dczhifeng: "猘锋",
	dczhifeng_info: "每回合限X次（X为场上人数）。当你的手牌数：大于体力值时，你可将至少一张黑色牌当作不计入次数的【酒】使用；小于体力值时，你可将一张红色牌当作无距离限制的任意【杀】使用或打出，然后将手牌摸至体力上限；等于体力值时，你可将任意张牌当作【决斗】对至多两名角色使用。",
	dcweijing: "威靖",
	...
	dcfuji: "缚己",
	dcfuji_info: "每轮限一次，其他角色出牌阶段开始时，你可令其观看你的手牌。若如此做，本回合结束时你回复1点体力并摸三张牌，且本轮你成为其他角色使用牌的目标时，你可将所有手牌交给一名其他角色并令此牌无效。",
	...
	houzhaoning: "侯昭宁",
	dcwangzi: "望资",
	dcwangzi_info: "每轮限一次，一名角色的出牌阶段开始时，你可弃置至多弃五张牌并令其从牌堆获得等量黑色牌，此阶段其使用这些牌后你与其各摸一张牌。",
	dcherong: "和戎",
	...
	v_liubei_prefix: "威",
	dcliexiang: "烈骧",
	dcliexiang_info: "出牌阶段限一次，你可摸至多五张牌并对一名其他角色造成一点伤害，若你的手牌数：1.大于其，本回合你出【杀】次数+1且可以交给一名其他角色至多X张牌；2.等于其，你获得其一张牌且其下回合使用的前X张牌无效；3.小于其，你失去X点体力并对其造成1点伤害，此技能本回合修改为“出牌阶段限两次”且可额外选择至多X名其他角色（X为你选择的摸牌数）。",
	dcrengou: "仁彀",
