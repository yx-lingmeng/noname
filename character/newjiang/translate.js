...
const translates = {
	...
	mbquesong: "雀颂",
	mbquesong_info: "一名角色的结束阶段，若你于本回合受到过伤害，你可以令至多三名角色选择一项：1.摸4-X张牌并复原武将牌；2.弃置X-1张牌然后回复1点体力（X为此次选择的角色数）。若你本回合受到过伤害的次数大于X，被选择的角色可以依次执行两项，然后其 非锁定技失效直到其下个回合开始。",
	old_mbquesong: "雀颂",
	...
	chenshi: "陈式",
	qingbei: "擎北",
	qingbei_info: "①每轮开始时，你可以选择任意种花色，你不能于本轮内使用这些花色的牌。②你使用牌结算结束后，你摸X张牌（X为你本轮〖擎北①〗选择的花色数）。",
	feiyao: "费曜",
	zhenfeng: "镇锋",
	...
	yj_fazheng_prefix: "☆",
	youtan: "忧叹",
	youtan_info: "锁定技，①你于出牌阶段外获得牌时，记录此牌花色；你于出牌阶段内不能使用此技能未记录的花色的牌。②你成为其他角色使用牌的目标时，若此牌花色你未记录，其须弃置一张牌，否则此牌对你无效。",
	ciren: "辞任",
	ciren_info: "其他角色的准备阶段，其可以交给你一张牌，然后你须选择一项：1.交给其另一张同花色牌；2.令其摸一张牌。",
	zhancai: "展才",
	zhancai_info: "出牌阶段限一次，你可以摸〖忧叹〗记录花色数张牌，然后清除一个记录的花色。",
};
