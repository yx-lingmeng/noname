...
const translates = {
	...
	sbjieyin: "结姻",
	sbjieyin_info: "使命技，你的登场势力为蜀。①游戏开始时，你令一名其他角色获得1枚“助”。②出牌阶段开始时，有“助”的角色选择一项：1.交给你X张手牌（X=min(2,其手牌数)且至少为1），然后获得1点护甲；2.令你将“助”移动给另一名其他角色，或移去其“助”（若其此前获得过“助”，则只能移去）。③失败：当一名角色死亡后，若其于死亡时有“助”，或当你因〖结姻②〗移去“助”后，你将势力改为吴，回复1点体力，获得所有“妆”并减1点体力上限。",
	sbliangzhu: "良助",
	...
	sb_zhanghe: "谋张郃",
	sbqiaobian: "巧变",
	sbqiaobian_info: "准备阶段，你可弃置任意张不同区域内的牌，然后跳过等量个阶段，并于跳过对应阶段后可以执行相应效果。若你以此法跳过：1.摸牌阶段，你可以获得至多两名其他角色各一张手牌；2.出牌阶段，你可以移动场上一张牌，然后若你装备区内的牌数未增加，则你可令因此场上牌数增加的角色摸一张牌；3.弃牌阶段，你摸一张牌，结束阶段，若你手牌数不小于场上角色数，你执行一个额外的出牌阶段。",
	sbliaoshi: "料势",
	//sbliaoshi_info: `每回合限一次，你可将因${get.poptip("sbqiaobian")}获得的牌当任意基本牌使用或打出。`,
	sbliaoshi_info: `每回合限一次，你可将因${get.poptip("sbqiaobian")}获得的牌当【杀】或【闪】使用或打出。`,
	old_sbqiaobian: "巧变",
	...
	sb_zhuran_prefix: "谋",
	sbzhenwei: "镇围",
	//sbzhenwei_info: "出牌阶段限一次，你可以选择一名其他角色，与其同时选择是否弃置任意张牌。然后你可以选择至多X项执行（X为你弃置牌对比其弃置牌不小于的条件数：1、花色数；2、类别数；3、牌数）：1.对其造成1点伤害；2、摸两张牌；3、获得1点护甲。",
	sbzhenwei_info: "出牌阶段限一次，你可以选择一名其他角色，与其同时选择是否弃置任意张牌。然后你可以选择至多X项执行（X为你弃置牌对比其弃置牌不小于的条件数：1.牌数；2.花色数）：1.对其造成1点伤害；2.摸两张牌。",
	sbheyuan: "合援",
