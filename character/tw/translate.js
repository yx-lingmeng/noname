...
const translates = {
	...
	twtaoluan: "讨乱",
	twtaoluan_info: "每回合限一次，当一名角色的判定结果确认时，你可以弃置一张与判定结果花色相同的牌，然后终止导致此判定发生的上级事件。",
	twshiji: "势击",
	twshiji_info: "准备阶段，你从牌堆或弃牌堆中获得两张花色不同的牌，然后你可以弃置一张牌，与弃置牌花色相同的牌于本回合内被展示后，你摸一张牌。你使用【火攻】造成伤害后，可以弃置目标角色的展示牌。",
	twzhengjun: "整军",
	twzhengjun_info: "当你不因使用或打出失去手牌后，你可以选择一项：1.从牌堆或弃牌堆中获得一张【火攻】；2.将手牌补至体力上限。然后若你本轮因此技能获得的牌数不小于2，此技能本轮失效。",
};
