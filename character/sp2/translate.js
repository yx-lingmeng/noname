...
const translates = {
	...
	starfanglang: "放浪",
	starfanglang_info: "摸牌阶段，你可以改为只摸一张牌并展示之，然后直到你的下回合开始，除展示的牌之外，你每回合使用或打出第一张牌时，你摸X张牌（X为此牌与展示牌的类别、花色、点数相同的项数）。结束阶段，你可以弃置一张牌，然后你获得弃牌堆中与此牌类别、点数、花色相同的牌各一张牌。",
	caobao: "曹豹",
	yanjiu: "厌酒",
	yanjiu_info: "锁定技，每轮结束时，你失去X点体力，若未因此失去体力你回复1点体力。（X为你本轮使用或弃牌阶段弃置的【酒】数量）",
	poyin: "迫饮",
	poyin_info: "锁定技，回合开始时，你摸体力上限张牌，并选择其中已损失体力值或当前体力值张牌视为【酒】，回合结束时，手牌数全场最多的角色质疑你手牌中【酒】数量是否大于其他手牌数，若成功其从牌堆中获得一张【杀】，若失败你可重铸任意张牌。",
};
