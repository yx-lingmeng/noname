...
const translates = {
	...
	olchenshuo: "谶说",
	olchenshuo_info: "准备阶段，你可以令一名角色展示一张手牌，然后亮出牌堆顶的一张牌。若这两张牌类型/花色/点数/牌名字数中任一项相同且已展示的牌数小于3，则你重复此流程，然后你获得所有展示牌。",
	oltianhou_spade: "骤雨",
	...
	olshanjia: "缮甲",
	olshanjia_info: "①游戏开始时，你获得3枚“损”标记。②当你不因使用失去一张装备牌后，你失去1枚“损”标记。③出牌阶段限一次，你可以摸三张牌，然后你可以使用一张【杀】。本阶段你使用下X张手牌时弃置一张牌（X为你此时拥有的“损”标记数）；本阶段结束时，若你本阶段未因此法弃置过非装备牌，则你可以视为使用一张无距离限制的【杀】。",
	ol_zhaozhong: "赵忠",
	olpengbi: "朋比",
